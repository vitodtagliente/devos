...
class InterruptManager
{
    ...
    protected:
        ...
        static InterruptManager* singleton;
        ...
        static void SetInterruptDescriptorTableEntry(unsigned char interrupt,
            unsigned short codeSegmentSelectorOffset, void (*handler)(),
    ...
    public:
        InterruptManager(unsigned short hardwareInterruptOffset, GlobalDescriptorTable* globalDescriptorTable/*, TaskManager* taskManager*/);
        ~InterruptManager();
        unsigned short HardwareInterruptOffset();
        void Enable();
        void Disable();
